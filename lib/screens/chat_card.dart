...
class _ChatCardState extends State<ChatCard> {
  ...
  getProductDetails(){
    _service.getProductDetails().then((value){
      setState(() {
        doc = value;
      });
    });
        ...
        children: [
          ...
          ListTile(
            onTap: (){
              ...
              Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => ChatConversations(
 ...
 /* FirebaseService _service = FirebaseService();
  ...
  getProductDetails(){
    _service.getProductDetails().then((value){//widget.chatData['product']['productId']
      setState(() {
        doc = value;
      });
    });
